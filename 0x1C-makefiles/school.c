...
void print_holberton(void)
{
	...
	print("j#00000k+]++]+++]+]++qwW0000000AgW00000");
	print("j#00000k++]++]+]+++qW#00000000000000000");
	print("j#00000A]++]++]++]++J**0000000000000000");
	print("j#000000e]++]+++]++]++]J000000000000000");
	print("j#0000000A]++]+]++]++]++000000000000000");
	print("j#000000000w]++]+]++]+qW#00000000000000");
	print("j#00000000000w]++++]*0##000000000000000");
	print("j#0000000000000Ag]+]++*0000000000000000");
	print("j#00000000000000000we]+]Q00000000000000");
	print("j#0000000000000@@+wgdA]+J00000000000000");
	print("j#0000000000000k?qwgdC=]4#0000000000000");
	print("j#00000000000000w]+]++qw#00000000000000");
	print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
